...
export class Pair {
  ...
  // public readonly lastBlockTimestamp: JSBI
  public readonly liquidityFee: JSBI
  ...
  public constructor(
    ...
    // this.lastBlockTimestamp = parseBigintIsh(lastBlockTimestamp)
  }
  ...
  public getOutputAmount(inputAmount: TokenAmount): [TokenAmount, Pair] {
    ...
    const inputAmountWithFee = JSBI.multiply(inputAmount.raw, JSBI.subtract(_10000, this.liquidityFee))
  ...
  public getInputAmount(outputAmount: TokenAmount): [TokenAmount, Pair] {
    ...
    const denominator = JSBI.multiply(
        ...
        JSBI.subtract(_10000, this.liquidityFee)
    )
